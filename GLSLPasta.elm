...
type alias PartId = Types.PartId

type alias Name = Types.Name

type alias Value = Types.Value

type alias Type = Types.Type

type alias Global = Types.Global
...
combineWith = Internal.combineWith
